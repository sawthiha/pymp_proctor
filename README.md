# Reproducible Experimental Results for MediaPipe Proctoring Solution
...
## Sources
- [MediaPipe Calculators](https://github.com/sawthiha/mediapipe_calculators.git)
- [MediaPipe Graphs](https://github.com/sawthiha/mediapipe_graphs.git)
